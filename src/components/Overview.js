      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 lg:mt-20 text-center animate-on-scroll opacity-0 translate-y-8">
          ...
          <button
            ...
            className="ml-4 group inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-md text-indigo-600 bg-white border-2 border-indigo-600 hover:bg-indigo-50 transform hover:scale-105 transition-all duration-300"
          >
            Contact Us Today
            <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
          </button>
